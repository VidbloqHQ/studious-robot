...
//       setReactions((prev: ReactionData[]) => [...prev, reactionData]);

//       // Remove the reaction after a timeout (3 seconds)
//       setTimeout(() => {
//         setReactions((prev: ReactionData[]) => 
//           prev.filter((r) => r.reaction !== reactionData.reaction || r.sender !== reactionData.sender)
//         );
//       }, 3000);
//     };
