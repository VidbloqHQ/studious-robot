...
// //     // Prevent disconnecting if the connection was just established
// //     if (ws.current && Date.now() - lastConnectedTime.current > 3000) {
...
//    */
//   const disconnect = useCallback(() => {
//     // Prevent disconnecting if the connection was just established (30 seconds)
...
//       // Only disconnect if it's been a while since we connected
//       if (ws.current && Date.now() - lastConnectedTime.current > 5000) {
